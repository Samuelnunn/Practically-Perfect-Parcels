  ...
  up: async (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Products', [
      ...
      },
      {
        ...
        productDescription: '‘Tis the season to curl up with some tea, your favorite journal, and a little Disney magic! This parcel is for anyone whose aesthetic is the cozy writer type',
        price: '$45.00',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      ...
      },
      {
        ...
        productDescription: '"Don’t let the muggles get you down.” If you can’t make it to Hogwarts this year, why not bring all the magic to you! We ship everywhere that mail can be received, including cupboards under the stairs',
        price: '$70.00',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      ...
      },
      {
        ...
        productDescription: 'Where have all the good men gone and where are all the gods, you ask? They joined the Avengers! If you’re holding out for a hero, the wait is over. This parcel is sure to save the day the next time you need a gift for the marvel lover in your life',
        price: '$65.00',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      ...
      },
      {
        ...
        productDescription: 'It doesn’t matter if the cup is half empty or half full as long as it’s a Disney mug. This box comes with 3 mugs included in this picture',
        price: '$60.00',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      ...
      },
      {
        ...
        productDescription: 'This box is the perfect gift for anyone who likes putting pen to paper (and sipping some Disney tea while they’re at it). We love these VHS cassette journals, and right now you can get them themed after Toy Story, Lilo and Stich, or The Emperor’s New Groove',
        price: '$60.00',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
